...
embed route prefix. A cross-package contract test pins these against the backend
so the two cannot drift; a silent drift would route jobs to a queue the worker
never drains or send an unrecognized identity header.
"""
