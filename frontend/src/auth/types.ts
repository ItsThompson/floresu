 ...
 * errors so the form can attach them to the offending input and preserve entry.
 */
export type AuthResult = { ok: true } | { ok: false; message: string; fields?: Record<string, string> };
