...
/**
 * The subset of the RFC 9457 problem+json body the auth forms use: a human
 * `detail`/`title` and an optional field-level map. Other members
 ...
 * carries `detail` and, for conflicts/validation, a `fields` map. A malformed or
 * empty body degrades to a generic message rather than surfacing `undefined`.
 */
