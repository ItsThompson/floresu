"""Integration tests for the embeddings migration (0011) against real Postgres.
...
the migration is reversible back to 0010_resumes; and the autogenerate-hazard guard: every
...
def test_migration_is_reversible(postgres_url: str, monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    command.downgrade(config, "0010_resumes")
