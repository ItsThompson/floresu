...
host: the Site-URL gotcha means a request-derived issuer would be rejected by
clients that opened the flow at the pinned public origin. ``S256`` is advertised
as the only PKCE method, matching the enforcement in the flow.
"""
